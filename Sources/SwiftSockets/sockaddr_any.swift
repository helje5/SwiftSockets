...
public enum sockaddr_any {
  ...
  public var len: __uint8_t {
    #if os(Linux)
      switch self {
      case .AF_INET:  return __uint8_t(sizeof(sockaddr_in))
      case .AF_INET6: return __uint8_t(sizeof(sockaddr_in6))
      case .AF_LOCAL: return __uint8_t(sizeof(sockaddr_un)) // TODO: wrong
      }
    #else
      switch self {
